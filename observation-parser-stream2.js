...
util.inherits(ObservationParserStream, stream.Transform);
...
ObservationParserStream.prototype._transform = function(chunk, encoding, callback) {
	this._parser.write(chunk);
	callback();
};

ObservationParserStream.prototype._flush = function(callback) {
	this._parser.end();
	callback();
};
